...
public class MetaItemTooltipOverlay {
    ...
    public static void init() {
        MinecraftForge.EVENT_BUS.register(new MetaItemTooltipOverlay());
    }
    ...
    public void onRenderTooltip(RenderTooltipEvent.PostText event)
    {
        ...
        if (!MetaItemFoodHelper.isFood(hoveredStack))
            return;
        ...
        MetaItemFoodHelper.BasicFoodValues defaultFoodValues = MetaItemFoodHelper.getDefaultFoodValues(hoveredStack);
        MetaItemFoodHelper.BasicFoodValues modifiedFoodValues = MetaItemFoodHelper.getModifiedFoodValues(hoveredStack, player);
